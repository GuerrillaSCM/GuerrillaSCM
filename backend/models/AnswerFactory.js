...
const MultipleChoiceAnswerSchema = require('./answers/MultipleChoiceAnswer');
...
var MultipleChoiceAnswer = Answer.discriminator('MultipleChoiceAnswer', MultipleChoiceAnswerSchema);
